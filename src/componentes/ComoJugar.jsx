    ...
    <section className='comoJugar' data-theme={isClaro ? "light" : "dark"}>
        ...
        <main className='comoJugar_main'>
            ...
            <div>
                ...
                <ul>
                    <li><strong>Selecciona los dígitos:</strong> En la parte inferior de la pantalla, verás botones numerados del 0 al 9. Haz clic en estos botones para armar tu número. Los dígitos seleccionados aparecerán en la fila activa de la cuadrícula.</li>
                    <li><strong>Borrar un dígito:</strong> Si deseas corregir el último dígito ingresado, haz clic en el botón "Borrar".</li>
                    <li><strong>Enviar tu intento:</strong> Cuando tengas un número de 4 dígitos completo, presiona "Enviar" para recibir retroalimentación sobre tu intento.</li>
                </ul>
            </div>
            <div>
                ...
                <ul>
                    <li><strong>Enviar tu intento:</strong>x Muestra cuántos dígitos están en la posición correcta.</li>
                    <li><strong>Amarillo (Regular):</strong> Indica la cantidad de dígitos que son correctos pero están en una posición incorrecta.</li>
                    <li><strong>Rojo (Mal):</strong> Señala los dígitos incorrectos que no forman parte del número secreto.</li>
                </ul>
            </div>
            <div>
